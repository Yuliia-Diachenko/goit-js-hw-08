...
// створюємо модалку зі збільшеним зображенням за допомогою бібліотеки basicLightbox
list.addEventListener("click", (event) => {
   event.preventDefault();  // скидаємо дефолтні налаштування браузеру
   if (event.target.nodeName !== "IMG") {
        return; // користувач клікнув між картинками
      }
